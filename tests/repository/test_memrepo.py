...
def test_respository_list_with_price_equal_filter(room_dicts, price):
    repo = MemRepo(room_dicts)
...
def test_respository_list_with_price_greater_than_filter(room_dicts, price):
    repo = MemRepo(room_dicts) 
...
def test_respository_list_with_price_between_filter(room_dicts):
    repo = MemRepo(room_dicts)
